...
export const HoverEffect = ({
  ...
  return (
    <div
      className={cn(
        "flex justify-center py-10 ", // Flexbox for centering
        className
      )}
    >
      <div 
        ...
        className={cn(
          "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 w-full lg:w-4/5 ", // 80% width for large screens
          className
        )}
      >
        {items.map((item, idx) => (
...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-zinc-100 font-bold tracking-wide mt-3", className)}>
      {children}
    </h4>
  );
};
