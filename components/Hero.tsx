...
import profilepic from "../public/pic3.webp";
interface cv {
  CV: string;
  link: string;
}
    ...
    <>
      ...
      >
        <div className="w-full md:w-[50%]  h-[100%] flex flex-col pl-6 md:pl-10 lg:pl:15 items-start justify-center order-2 md:order-1">
          <div className="w-full flex flex-row justify-start items-center">
            <span className="text-bold text-xl md:text-xl font-semibold text-zinc-50 font-Montserrat">
              {" "}
              Hi I'm
            </span>{" "}
            <br />
          ...
          <span className="text-bold text-3xl md:text-4xl font-extrabold text-zinc-300 font-Montserrat mt-2 ">
            {" "}
            <FlipWords words={words} />
          </span>
          <p className="text-gray-400 text-sm pt-2 ">
            IT undergraduate at the University of Moratuwa, skilled in front-end
      ...
      >
        <div className="w-full flex items-center justify-center h-auto">
          <TextGenerateEffect
            words="About Me"
            className="text-bold text-2xl md:text-4xl font-semibold text-white font-Montserrat"
          />
        </div>
        ...
        <div className="w-full h-auto flex flex-col md:flex-row items-center justify-center mt-10">
          ...
          >
            <TextGenerateEffect
              words={aboutme}
              className="text-zinc-400 md:text-base text-sm font-light  text-center "
            />
            <span>
              Email:{" "}
              <a href="#" className="text-zinc-300 text-sm font-bold mt-2">
